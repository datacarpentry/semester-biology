...
curl -O http://www.programmingforbiologists.org/data/data-greencanyon-2013.txt
curl -O http://www.programmingforbiologists.org/data/data-logancanyon-2013.txt
```
...
`python species_counts.py data-greencanyon-2013.txt`

This can then be integrated into our pipeline. So if we want to sort based
on the total number of individuals:

`python species_counts.py data-greencanyon-2013.txt | sort -k 2 -n`
