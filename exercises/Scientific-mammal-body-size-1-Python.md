...
Download the
[largest dataset on mammalian body size in the world](https://esapubs.org/archive/ecol/E084/094/MOMv3.3.txt).
...
the [metadata](https://esapubs.org/archive/ecol/E084/094/metadata.htm) to
