--- layout: post title: 5. Libraries 1 [problem] created: 1315531133
categories: - !binary |- MQ== - !binary |- YWR2 - !binary |- MQ== -
!binary |- YWR2 - !binary |- MQ== - !binary |- YWR2 ---

This is a follow up to the [Higher Order Functions
2](http://www.programmingforbiologists.org/higher-order-functions-2-problem)
problem.\
\
