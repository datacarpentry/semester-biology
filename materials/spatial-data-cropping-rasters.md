...
harv_dtm <- rast("data/HARV/HARV_dtmCrop.tif")
...
* For `sf` vector data we can also skip teh `ext` function from terra (for "extent") and just pass the named vector with xmin, xmax, ymin, and ymax directly
